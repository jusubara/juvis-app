...
const modules = [
  {
    ...
    description: "급여, 수당, 퍼듐 등을 정밀 계산합니다.",
    status: "ONLINE",
  ...
  },
  {
    ...
    description: "파일럿 비행 로그북. 모바일 앱 개발완료.",
    status: "ONLINE",
    statusColor: "text-emerald-400",
    dotColor: "bg-emerald-400",
    dotShadow: "0 0 6px #34d399",
  ...
  },
  {
    ...
    description: "OCR 기능을 이용한 전자로그북 개발중",
    status: "ONLINE",
    statusColor: "text-emerald-400",
    dotColor: "bg-emerald-400",
    dotShadow: "0 0 6px #34d399",
  ...
  },
  {
    ...
    title: "PDF/이미지 유틸리티",
    titleEn: "PDF Toolbox",
    description: "PDF 합치기·분할, 이미지 포맷 변환·리사이즈를 브라우저에서 바로 처리합니다.",
    status: "ONLINE",
    statusColor: "text-emerald-400",
    dotColor: "bg-emerald-400",
    dotShadow: "0 0 6px #34d399",

  ...
  return (
    <main className="min-h-screen grid-bg flex flex-col items-center justify-center relative">
      ...
      <div className="relative z-10 text-center px-6">
        ...
        <p className="text-[10px] font-mono text-cyan-600 tracking-widest mb-2">[INVEST]</p>
        <h1 className="text-2xl font-bold text-cyan-300 font-mono glow-text mb-1">투자 포트폴리오</h1>
        <p className="text-xs text-cyan-600 font-mono mb-10">Investment Portfolio</p>
